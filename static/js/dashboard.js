...
days.forEach(function(day,index){
    {
        ...
        if(index == left_counter || index == left_counter+1){
        ...
        daysTemplate += `
        <li index="${index}" class="custom-tooltip-2 ${tip_left ? 'tip_left' : ''} ${day.currentMonth ? '' : 'another-month'} ${day.today ? ' active-day ' : ''}${day.selected ? 'selected-day' : ''}" data-day="${day.dayNumber}" data-month="${day.month}" date-notification="yes" data-year="${day.year}"><div class="dot"></div><div class="tooltiptext-2">Fetching</div></li>
        `
        }
        else daysTemplate += `
        <li index="${index}" class="custom-tooltip-2 ${day.currentMonth ? '' : 'another-month'} ${day.today ? ' active-day ' : ''}${day.selected ? 'selected-day' : ''}" data-day="${day.dayNumber}" data-month="${day.month}" date-notification="yes" data-year="${day.year}"><div class="tooltiptext-2 ${tip_left ? 'tip-left' : 'tip-normal'}">Fetching</div></li>
        `
        }
});
